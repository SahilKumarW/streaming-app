...
//     const [currentUser, setCurrentUser] = useState(null); // Currently edited user
//     const [activeTab, setActiveTab] = useState("users");

//     // Simulate fetching users from an API (mocked data)
//     useEffect(() => {
//         setTimeout(() => {
//             setUsers([
//                 { id: 1, fullName: "Matthew Wilson", level: "Super Admin", accountCreated: "06-03-2024", subscription: "06-03-2021", avatar: "/Assets/mathew.png" },
//                 { id: 2, fullName: "Jaggy Martinez", level: "Super Admin", accountCreated: "06-03-2024", subscription: "06-03-2021", avatar: "/Assets/jeo.jpg" },
//                 { id: 3, fullName: "Christopher Brown", level: "Admin", accountCreated: "18-03-2024", subscription: "20-03-2021", avatar: "/Assets/bale.jpg" },
//                 { id: 4, fullName: "Emily Thompson", level: "Manager", accountCreated: "11-06-2024", subscription: "11-06-2021", avatar: "/Assets/SCARLET.jpg" },
//                 { id: 5, fullName: "David Smith", level: "Manager", accountCreated: "25-06-2024", subscription: "28-06-2021", avatar: "/Assets/leo.jpg" },
//             ]);
//             setIsLoading(false);
//         }, 1000);
//     }, []);
...
//     const handleSaveEdit = (updatedUser) => {
//         // Simulate the API request and update the local state
//         const updatedUsers = users.map((user) =>
//             user.id === updatedUser.id ? updatedUser : user
//         );
//         setUsers(updatedUsers);
...
//                             activeTab === "users" ? "underline text-teal-500" : ""
//                         }`}
//                         onClick={() => setActiveTab("users")}
//                     >
//                         Users
