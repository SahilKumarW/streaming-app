  ...
  return (
    <div className='w-[413px] h-[345px] bg-[#1A1A1A] border border-[#262626] rounded-[10px]'>
      ...
      <div className='flex mt-[40px] pl-[40px] gap-3'>
        <button className=' w-[160px] h-[49px] font-semibold text-[14px] leading-[21px] bg-black rounded-md'>Start Free Trial</button>
        <button className=' w-[160px] h-[49px] font-semibold text-[14px] leading-[21px] bg-custom-gradient rounded-md'>Choose Plan</button>
      </div>
    </div>
  )
}
